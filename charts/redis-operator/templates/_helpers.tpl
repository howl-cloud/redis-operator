...
{{/*
Selector labels used in pod selectors and services.
*/}}
...
{{/*
Compute the operator container image reference.
*/}}
...
{{/*
Name of the Secret used for webhook TLS certificates.
Defaults to "<fullname>-webhook-cert" if not overridden in values.
*/}}
{{- define "redis-operator.webhookCertSecretName" -}}
{{- default (printf "%s-webhook-cert" (include "redis-operator.fullname" .)) .Values.webhook.certSecretName }}
{{- end }}
